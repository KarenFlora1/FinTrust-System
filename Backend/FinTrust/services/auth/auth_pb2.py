...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_TOKENREQUEST']._serialized_end=167
  _globals['_VALIDATERESPONSE']._serialized_start=169
  _globals['_VALIDATERESPONSE']._serialized_end=236
